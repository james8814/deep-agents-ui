 ...
 */
export function getTypographyScale(scale: keyof typeof typographySystem.headings) {
  return typographySystem.headings[scale as keyof typeof typographySystem.headings];
}
